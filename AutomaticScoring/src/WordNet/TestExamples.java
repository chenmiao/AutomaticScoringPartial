...
//// all senses
//		TreeMap<String, Double> 	scores2	=	lin.lin("apples", "banana", "n");			// all senses
...
//// specific senses
//		System.out.println("\nspecific pair\t=\t" + lin.lin("apples", 1, "banana", 1, "n") + "\n");
//// max.
//		System.out.println("\nhighest score\t=\t" + lin.max("apples", "banana", "n") + "\n\n\n");
...
//		path measure
		...
		TreeMap<String,Double> scores3=path.path("certain", "available", "n");//all senses
		System.out.println(scores3.size());
		for (String s : scores3.keySet()){
			System.out.println(s+"\t"+scores3.get(s));
		}
//		double spec=path.path("apple", 1, "banana",2,"n");
//		System.out.println(spec);
//		
//		System.out.println(POS.VERB.getTag());
	}
} // eof
